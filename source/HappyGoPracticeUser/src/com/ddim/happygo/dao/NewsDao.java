...
public class NewsDao {
	...
	public final static String TABLE_NAME = "HG_NEWS";
	private SimpleJdbcInsert simpleJdbcInsert;

	@Autowired
	public void init(DataSource dataSource) throws Exception {
		simpleJdbcInsert = new SimpleJdbcInsert(dataSource).withTableName(TABLE_NAME).usingColumns("ID", "NAME",
				"DESCRIPTION", "IMAGE", "START_TIME", "END_TIME", "STATUS", "SORT", "CREATOR", "CREATE_TIME",
	 ...
	 * @throws Exception
	 */
	public Page<News> findPage(String name, String status, PagingParameter paging) throws Exception {
		...
		return simpleJdbc.findPage(sb.toString(), args.toArray(), paging, ClassRowMapperFactory.get(News.class));
	}
	...
	public News get(String id) throws Exception {
		...
		sb.append(" WHERE ID=?");
		Object[] args = { id };
		return simpleJdbc.getFirst(simpleJdbc.query(sb.toString(), args, ClassRowMapperFactory.get(News.class)));
	}
	 ...
	 * @throws Exception
	 */
	public void insert(News entity) throws Exception {
	...
	public void update(News entity) throws Exception {
		String sql = "UPDATE " + TABLE_NAME
				+ " SET NAME=?, DESCRIPTION=?, IMAGE=?, START_TIME=?, END_TIME=?, STATUS=?, MODIFIER=?, MODIFY_TIME=? WHERE ID=?";
		Object[] args = { entity.getName(), entity.getDescription(), entity.getImage(), entity.getStart_time(),
				entity.getEnd_time(), entity.getStatus(), entity.getModifier(), entity.getModify_time(),
				entity.getId() };
