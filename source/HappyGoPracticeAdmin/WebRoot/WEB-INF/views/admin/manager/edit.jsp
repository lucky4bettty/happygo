			...
			<tbody>
				<tr>
					...
					<td><c:choose>
						...
						</c:choose> <br> <form:errors path="account" cssClass="red" /></td>
				</tr>
				<tr class="bg">
					<th scope="row"><span class="red">※</span>密碼</th>
					<td><form:password path="newPwd" size="20" maxlength="20" />
						<form:hidden path="pwd" /> <span style="color: green;">密碼長度3~20碼英文或數字</span>
						<br> <form:errors path="pwd" cssClass="red" /></td>
				</tr>
				<tr>
					<th scope="row"><span class="red">※</span>姓名</th>
					<td><form:input path="name" maxlength="20" /> <br> <form:errors
				...
				<tr class="bg">
					...
					<td><form:input path="mobile" maxlength="50" /> <br> <form:errors
							path="mobile" cssClass="red" /></td>
				</tr>
				<tr>
					<th scope="row"><span class="red"></span>電話</th>
					<td>
				...
				<tr class="bg">
					...
					<td><form:select path="role_id">
						...
						</form:select> <br> <form:errors path="role_id" cssClass="red" /></td>
				</tr>
				<tr>
					...
					<td><c:choose>
							...
							<c:otherwise>啟用<form:hidden path="status" />
							</c:otherwise>
						</c:choose></td>
				</tr>
			</tbody>
