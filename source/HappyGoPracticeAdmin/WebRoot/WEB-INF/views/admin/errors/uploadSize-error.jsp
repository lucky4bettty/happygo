...
<body
	onLoad="MM_preloadImages('${contextPath}/resources/images/01_addid_f2.gif', '${contextPath}/resources/images/01_delete_f2.gif')">
	<div align="center">
		<table width="960" border="0" cellpadding="0" cellspacing="0"
			bordercolor="#666666">
			<tr>
				<td><table width="960" border="0" cellpadding="2"
						cellspacing="0" bordercolor="#666666">
						<tr align="center" valign="middle">
							<td width="960"><c:import
									url="/WEB-INF/views/commons/header.jsp" charEncoding="utf-8" />
							</td>
						</tr>
						<tr>
							<td valign="top"><table width="100%" border="0"
									...
									<tr>
										<td width="13" height="17"
											background="${contextPath}/resources/images/01.gif"></td>
										<td background="${contextPath}/resources/images/02.gif"></td>
										<td width="17" height="17"
											background="${contextPath}/resources/images/06.gif"></td>
									</tr>
									<tr>
