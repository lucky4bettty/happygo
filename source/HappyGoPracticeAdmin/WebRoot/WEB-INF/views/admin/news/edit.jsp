		...
		<table class="tbType" cellspacing="0" cellpadding="0" border="0"
			...
			<tbody>
				...
				<tr class="bg">
					...
					<td><form:textarea path="description" rows="10" cols="20"
				...
				<tr>
					...
					<td><form:input path="start_time" /> <form:errors
							path="start_time" cssClass="error" /></td>
				</tr>
				<tr>
					<th scope="row"><span class="red">※</span>下架時間</th>
					<td><form:input path="end_time" /> <form:errors
							path="end_time" cssClass="error" /></td>
				</tr>
				<tr>
