...
public class NewsService {
	...
	public Page<News> findPage(String name, String status, PagingParameter paging) throws Exception {
		return newsDao.findPage(name, status, paging);
	}
	...
	public void save(News entity, String modifier) throws Exception {
	...
	public void updateStatus(String[] ids, String status, String modifier) throws Exception {
		for (String id : ids) {
			News entity = get(id);
			newsDao.updateStatus(entity.getId(), status, modifier);
		}
	}
	...
	public void updateSort(int sortTemp, String id, int sort, String modifier) throws Exception {
		newsDao.updateSort(id, sort, sortTemp, modifier);
	}
